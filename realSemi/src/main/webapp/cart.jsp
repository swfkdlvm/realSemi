	...
	<div id= "rlcontainer">
		...
		<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: black;">
			  ...
			  <ul id="leftbar" class="navbar-nav mr-auto">
			    ...
			    <li class="nav-item">
			      <a class="nav-link text-white" href="#">>&nbsp;&nbsp;&nbsp;&nbsp;카트</a>
			    </li>
			  </ul>
		...
		<div id="content">
			<div id="item">
				<span style="font-size: 20pt; font-weight: bold;">딜리버리 카트</span>
				<img id="logo" src="<%= ctxPath%>/image/logo_brown.png">
				<div>카트에 담긴 메뉴가 없습니다</div>
			</div>
			<div class="text-center">
				<button id="addmenu" type="button" class="my-4">메뉴 추가 +</button>
			</div>
		</div>

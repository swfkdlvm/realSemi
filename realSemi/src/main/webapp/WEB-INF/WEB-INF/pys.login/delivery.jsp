	...
	<div id= "rlcontainer">
		...
		<nav class="navbar navbar-expand-sm navbar-dark" style="background-color: black;">
			  ...
			  <ul id="rightbar" class="navbar-nav ml-auto">  
			    <li class="nav-item">
			      <a class="nav-link disabled text-white" href="#" tabindex="-1" aria-disabled="true">기본주소 : ${sessionScope.loginuser.address} ${sessionScope.loginuser.detailaddress} ${sessionScope.loginuser.extraaddress}</a>
			    </li>
			    <li class="nav-item">
			    	<button id="change" type="button" class="btn btn-light" onclick="location.href='<%= ctxPath%>/member/infoChange.bk?userid=${(sessionScope.loginuser).userid}'">변경</button>
			    </li>
			  </ul>
			</nav>

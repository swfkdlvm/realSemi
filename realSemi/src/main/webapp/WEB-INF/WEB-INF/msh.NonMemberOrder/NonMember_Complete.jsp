...
function goIndex() {
	...
	location.href = `<%= ctxPath%>/index.bk`;
...
<body>
   ...
   <div class="label">
	...
	<form name="registerFrm">
	   	<div class="register">
			<h1 style="height:100px;">주문이 완료되었습니다!</h1>
			<br>
			<button type="button" class="register_btn" onclick="goIndex()" style="width:200px; height:100px; font-size:25px;">메인페이지 이동</button>
		</div>
	</form>

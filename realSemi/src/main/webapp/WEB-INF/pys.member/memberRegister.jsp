	   	...
	   	<table id="tblMemberRegister">
		   	...
		   	<tbody>
		   		...
		   		<tr>
                    ...
                    <td>
                       <input type="text" name="name" id="name" maxlength="30" class="requiredInfo" autocomplete="off" />
		   		...
		   		<tr>
                    ...
                    <td>
                       <input type="text" name="userid" id="userid" maxlength="40" class="requiredInfo" autocomplete="off" />&nbsp;&nbsp;  
                       <%-- 아이디중복체크 --%>
                ...
                <tr>
                    ...
                    <td>
                       <input type="text" name="email" id="email" maxlength="60" class="requiredInfo" autocomplete="off" />
                ...
                <tr>
                    <td>생년월일</td>
                    <td>
                       <input type="text" name="birthday" id="datepicker" maxlength="10" autocomplete="off" />

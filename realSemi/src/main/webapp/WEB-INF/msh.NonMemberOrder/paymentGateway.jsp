...
$(document).ready(function() {
   ...
   IMP.init('imp21410887');  // 중요!!  포트원(구:아임포트)에 가입시 부여받은 "가맹점 식별코드". 
   ...
   IMP.request_pay({
	   ...
	   */
		...
		*/
		...
		//	window.opener.nonmember_goUpdate();

		//  $(opener.location).attr("href", "javascript:goCoin_DB_Update('${requestScope.userid}','${requestScope.coinmoney}')");
		//	opener.location.href = "http://localhost:9090/tempSemifinal/index.bk";
			opener.location.href = "javascript:redirectToIndex();";

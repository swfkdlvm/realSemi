...
<body>
	...
	<nav class="navbar navbar-expand-sm">
  		<ul class="nav justify-content-center">
    		...
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="#" style="color: #E3242B; text-decoration: underline 3px;">치킨버거</a>
    		</li>
	  ...
	  <div class="row">
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/chickenbugger/롱치킨버거.png"></a>
	      </div>
	      <p><a href="#">롱치킨버거</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/chickenbugger/바비큐치킨버거.png"></a>
	      </div>
	      <p><a href="#">바비큐치킨버거</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/chickenbugger/치킨버거.png"></a>
	      </div>
	      <p><a href="#">치킨버거</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/chickenbugger/치킨킹.png"></a>
	      </div>
	      <p><a href="#">치킨킹</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/chickenbugger/치킨킹BLT.png"></a>
	      </div>
	      <p><a href="#">치킨킹BLT</a></p>
	    </div>
	  </div>

...
<body>
	...
	<nav class="navbar navbar-expand-sm">
  		<ul class="nav justify-content-center">
    		...
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="#" style="color: #E3242B; text-decoration: underline 3px;">와퍼</a>
    		</li>
    		<li class="nav-item pt-3">
	  ...
	  <div class="row">
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/whopper/갈릭불고기와퍼.png"></a>
	      </div>
	      <p><a href="#">갈릭불고기와퍼</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/whopper/불고기와퍼.png"></a>
	      </div>
	      <p><a href="#">불고기와퍼</a></p>
	    </div><div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/whopper/와퍼.png"></a>
	      </div>
	      <p><a href="#">와퍼</a></p>
	    </div><div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/whopper/치즈와퍼.png"></a>
	      </div>
	      <p><a href="#">치즈와퍼</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/whopper/콰트로치즈와퍼.png"></a>
	      </div>
	      <p><a href="#">콰트로치즈와퍼</a></p>
	    </div>
	  </div>
	</div>

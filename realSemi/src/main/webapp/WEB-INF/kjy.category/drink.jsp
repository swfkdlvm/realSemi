...
<body>
	...
	<nav class="navbar navbar-expand-sm">
  		<ul class="nav justify-content-center">
    		...
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="<%= ctxPath%>/category/chickenbugger.bk">와퍼</a>
    		</li>
    		<li class="nav-item pt-3">
    		...
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="<%= ctxPath%>/category/drink.bk">사이드</a>
    		</li>
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="#" style="color: #E3242B; text-decoration: underline 3px;">음료</a>
    		</li>
  		</ul>
	</nav>
	  ...
	  <div class="row">
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/아메리카노.png"></a>
	      </div>
	      <p><a href="#">아메리카노</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/핫초코.png"></a>
	      </div>
	      <p><a href="#">핫초코</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/아이스초코.png"></a>
	      </div>
	      <p><a href="#">아이스초코</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/코카콜라.png"></a>
	      </div>
	      <p><a href="#">코카콜라</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/코카콜라 제로.png"></a>
	      </div>
	      <p><a href="#">코카콜라 제로</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/스프라이트.png"></a>
	      </div>
	      <p><a href="#">스프라이트</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/스프라이트 제로.png"></a>
	      </div>
	      <p><a href="#">스프라이트 제로</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/미닛메이드 오렌지.png"></a>
	      </div>
	      <p><a href="#">미닛메이드 오렌지</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/drink/순수(미네랄워터).png"></a>
	      </div>
	      <p><a href="#">순수(미네랄워터)</a></p>
	    </div>

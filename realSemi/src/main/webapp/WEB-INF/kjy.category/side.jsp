...
<body>
	...
	<nav class="navbar navbar-expand-sm">
  		<ul class="nav justify-content-center">
    		...
    		<li class="nav-item pt-3">
      			<a class="nav-link" href="#" style="color: #E3242B; text-decoration: underline 3px;">사이드</a>
    		</li>
    		<li class="nav-item pt-3">
	  ...
	  <div class="row">
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/해쉬브라운.png"></a>
	      </div>
	      <p><a href="#">해쉬브라운</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/너겟킹.png"></a>
	      </div>
	      <p><a href="#">너겟킹</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/21치즈스틱.png"></a>
	      </div>
	      <p><a href="#">21치즈스틱</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/어니언링.png"></a>
	      </div>
	      <p><a href="#">어니언링</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/프렌치프라이.png"></a>
	      </div>
	      <p><a href="#">프렌치프라이</a></p>
	    </div>
	    <div class="col-sm-3">
	      <div class="image-frame p-3">
	        <a href="#"><img height="150px" src="<%= ctxPath%>/image/side/코울슬로.png"></a>
	      </div>
	      <p><a href="#">코울슬로</a></p>
	    </div>

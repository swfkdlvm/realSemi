...
<div class='container'>
	...
	<form id="noticeFrm" name="noticeFrm">
		<input type="hidden" name="seq" value="${temp_noticevo.seq}"/>
		<h5 class='text-left mb-3' style="margin-top: 80px">제목</h5>

	    <input type="text" name="subject" id="subject" value="${temp_noticevo.subject}" style='width: 100%; font-size: small;' />

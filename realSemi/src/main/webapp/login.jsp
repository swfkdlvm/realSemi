...
<%-- 직접 만든 CSS --%>
<link rel="stylesheet" type="text/css" href="<%= ctxPath%>/css/cart/login.css" />

<%-- Optional JavaScript --%>
<script type="text/javascript" src="<%= ctxPath%>/js/jquery-3.7.1.min.js"></script>
<script type="text/javascript" src="<%= ctxPath%>/bootstrap-4.6.2-dist/js/bootstrap.bundle.min.js" ></script> 

<script type="text/javascript" src="<%= ctxPath%>/js/cart/login.js"></script>
				...
				<tr>
					...
					<td style="text-align: right;">
						<div style="padding-right: 20px;">
							<button type="button" style="width: 160px; height: 50px; border-radius: 30px; background-color: rgb(81, 35, 20); border: none; color: white; font-size: 15pt; font-weight: bold;">회원가입</button>
						</div>
					</td>
				</tr>
			</tbody>
				...
				<table id="loginTbl">
					<tbody>
						...
						<tr>
							<td></td>
							<td>
								<input type="password" name="pwd" id="pwd" size="30" placeholder="비밀번호" style="border: none;" />
						...
						<tr>
							...
							<td><button type="button" id="btnSubmit" style="background-color: rgb(215, 35, 0);">로그인</button>
								<button type="button" id="btnRegister" style="background-color: rgb(81, 35, 20);">회원가입</button>
							</td>
						</tr>
						<%-- ==== 아이디 찾기, 비밀번호 찾기 --%>
						<tr>
